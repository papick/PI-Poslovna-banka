...
export class PaymentOrderComponent implements OnInit{
  ...
  ngOnInit() {
    ...
    if (this.route.snapshot.params.type === 'undefined') {
      ...
      this.analyticService.getPaymentOrder(type).subscribe(data => {
        ...
        this.form.controls['bankAccount'].setValue(data.accountCreditor.number);
  ...
  load() {
    ...
    console.log(file);
    this.router.navigateByUrl('/bank/' + idBank + '/payment-order/paymanent/' + file);
    location.reload();
  }
